...
class Dashboard_set extends CI_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model(array('student/Student_model', 'kredit/Kredit_model', 'debit/Debit_model', 'bulan/Bulan_model', 'bulan/Bulan_pay_model', 'setting/Setting_model', 'information/Information_model', 'bebas/Bebas_model', 'bebas/Bebas_pay_model'));
    ...
    public function index()
    {
        ...
        $data['bulanan_day'] = $this->Bulan_pay_model->get(array('date' => date('Y-m-d')));
        $data['total_kredit'] = 0;
        ...
        $data['bulan_bebas'] = 0;
        foreach ($data['bulanan_day'] as $row) {
            $data['bulan_bebas'] += $row['bulan_pay_bill'];
        }
        $data['total_bebas'] = 0;
