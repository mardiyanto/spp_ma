			...
			<div class="col-xs-12">
				<div class="box box-success">
					<div class="box-header with-border">
						<button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#addClass"><i class="fa fa-plus"></i> Tambah Data</button>
						<div class="box-tools">
							<?php echo form_open(current_url(), array('class' => 'form-horizontal', 'method' => 'get')) ?>
							<div class="input-group input-group-sm" style="width: 250px;">
								<input type="text" id="field" autofocus name="n" <?php echo (isset($f['n'])) ? 'placeholder="' . $f['n'] . '"' : 'placeholder="Cari Nama Kelas"' ?> class="form-control" required>
						...
						<table class="table table-hover table-striped table-bordered">
							...
							<tbody>
								...
								?>
										<tr>
											<td><?php echo $i; ?></td>
											<td><a href="<?php echo site_url('manage/student/index1?x=' . $row['class_id']) ?>"><?php echo $row['class_name']; ?></a></td>
			...
			<div class="modal-body">
				<div id="p_scents_class">
					<p>
						...
						<input type="text" required="" name="class_name[]" class="form-control" placeholder="Contoh: X atau XI atau XII">
					</p>
				</div>
...
<script>
	$(function() {
		...
		$("#addScnt_class").click(function() {
			$('<p><label>Nama Kelas</label><input required type="text" name="class_name[]" class="form-control" placeholder="Contoh: X atau XI atau XII"><br><a href="#" class="btn btn-xs btn-danger remScnt_class"><i class="fa fa-close"></i> <b>Hapus Baris</b></a></p>').appendTo(scntDiv);
			i++;
			return false;
		});
