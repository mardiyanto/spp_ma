				...
				<div class="row">
					...
					<div class="col-md-6">
						...
						<div class="col-md-6">
							...
							<input type="text" id="potongan" required="" name="potongan_pay_value[]" class="form-control numeric" placeholder="Jumlah" onfocus="unformatRupiah(this)" onblur="formatRupiah(this);">
						</div>
					</div>
				</div>
