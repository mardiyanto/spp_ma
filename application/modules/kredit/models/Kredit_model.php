...
class Kredit_model extends CI_Model {
	...
	function get($params = array())
	{
		...
		if (isset($params['kredit_jenis_jenis_id'])) {
			$this->db->where('kredit_jenis_jenis_id', $params['kredit_jenis_jenis_id']);
		}
		...
		$this->db->select('kredit_id, kredit_jenis_jenis_id, kredit_date, kredit_value, kredit_desc, kredit_input_date, kredit_last_update');
		$this->db->select('kredit_jenis_id , kredit_jenis_desc');
	...
	function add($data = array()) {
		...
		if(isset($data['kredit_jenis_jenis_id'])) {
			$this->db->set('kredit_jenis_jenis_id', $data['kredit_jenis_jenis_id']);
		}
