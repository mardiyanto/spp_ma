				...
				<div class="box box-success">
					<?php if ($this->session->userdata('uroleid') <> BENDAHARA) { ?>
						<div class="box-header with-border">
							<button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#addKredit"><i class="fa fa-plus"></i> Tambah Data</button>
							<a href="<?php echo site_url('manage/kredit_jenis') ?>" class="btn btn-success btn-sm"><i class="fa fa-plus"></i>Jenis Pengeluaran</a>
							<div class="box-tools">
				...
				<div id="p_scents_kredit">
					...
					<div class="row">
							...
							<select required="" name="kredit_jenis_jenis_id[]" class="form-control select2" style="width: 100%;">
								<option selected="selected">Pilih Jenis Pengeluaran</option>
								<?php foreach ($kredit_jenis as $j)
								{ ?>
