		...
		<div class="row">
			<div class="col-md-12">
				<div class="alert alert-warning">
					<b>PERINGATAN!</b> &nbsp;
					Halaman ini digunakan untuk merubah status <?php echo $this->config->item('siswa') ?> menjadi lulus. Pastikan siswa yang di proses adalah <?php echo $this->config->item('siswa') ?> kelas akhir.
				</div>
			</div>
		</div>
		<!-- /.box-header -->
					...
					<div class="box-body">
						...
						<div class="form-group">
							<div class="input-group">
								<div class="input-group-addon alert-success">Pilih kelas</div>
