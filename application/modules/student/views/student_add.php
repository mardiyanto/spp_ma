...
<div class="content-wrapper">
	...
	<section class="content-header">
		...
		<ol class="breadcrumb">
			...
			<li><a href="<?php echo site_url('manage/students') ?>">Manajemen <?php echo $this->config->item('siswa') ?></a></li>
					...
					<div class="box-body">
						<div class="nav-tabs-custom">
							<ul class="nav nav-tabs">
								...
								<li><a href="#tab_2" data-toggle="tab">Data <?php echo $this->config->item('sekolah') ?></a></li>
							...
							<div class="tab-content">
								...
								<div class="tab-pane" id="tab_2">
									<div class="form-group">
										<label>Nomor Induk  (NIM) <small data-toggle="tooltip" title="Wajib diisi">*</small></label>
									...
									<div class="form-group">
										<label><?php echo $this->config->item('nisn') ?> <small data-toggle="tooltip" title="Wajib diisi">*</small></label>
										<input name="student_nisn" type="text" class="form-control" value="<?php echo $inputNisNValue ?>" placeholder="<?php echo $this->config->item('nisn') ?>">
									</div>
									<?php if ($setting_level['setting_value'] == 'senior') { ?>
										<div class="form-group">
											<label><?php echo $this->config->item('jrr') ?> <small data-toggle="tooltip" title="Wajib diisi">*</small></label>
											<select name="majors_majors_id" class="form-control">
												<option value="">-- Pilih <?php echo $this->config->item('jrr') ?> --</option>
