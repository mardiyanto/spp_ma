                            ...
                            <tbody>
                                ...
                                $tt = $p['Total'];
                                    ...
                                    <tr>
                                        ...
                                        <td class="<?php echo ($row['bulan_status'] == 1) ? 'success' : 'danger' ?> text-center">  
                                        <?php  if ($sis== 0 ) { ?>
                                            <a  class="btn btn-xs btn-success"><i class="fa fa-file-text-o margin-r-5"></i><b>LUNAS</b></a>
    <?php  } else { ?>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="container">
                                                    ...
                                                    <div class="table-row">                                                       
                                                        ...
                                                        <div class="col"><a href="<?php echo site_url('manage/payout/hapus_bulan_pay/' . $row['payment_payment_id'] . '/' . $row['student_student_id'] . '/'. $row['bulan_id'] . '/' . $x['bulan_pay_id']) ?>">Hapus</a></div>
                                                    </div>
                                                    <?php
                                                    } 
                                                    ?> 
