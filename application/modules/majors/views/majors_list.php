				...
				<div class="box box-success">
					<div class="box-header with-border">
						...
						<div class="box-tools">
							...
							<div class="input-group input-group-sm" style="width: 250px;">
								<input type="text" id="field" autofocus name="n" <?php echo (isset($f['n'])) ? 'placeholder="' . $f['n'] . '"' : 'placeholder="Nama "' ?> class="form-control" required>
					...
					<div class="box-body table-responsive">
						<table class="table table-hover table-striped table-bordered">
							<tr>
								<th>No</th>
								<th>Nama <?php echo $this->config->item('jrr') ?></th>
								<th>Singkatan</th>
								<th>ID <?php echo $this->config->item('jrr') ?></th>
								<th>Aksi</th>
							</tr>
							<tbody>
								<?php
								...
								?>
										<tr>
											<td><?php echo $i; ?></td>
											<td><a href="<?php echo site_url('manage/student/index1?J=' . $row['majors_id']) ?>"><?php echo $row['majors_name']; ?></a></td>
	...
	<div class="modal-dialog modal-md">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">Tambah <?php echo $this->config->item('jrr') ?></h4>
			</div>
			...
			<div class="modal-body">
				<div id="p_scents_majors">
					<div class="row">
						<div class="col-md-6">
							<label>Nama <?php echo $this->config->item('jrr') ?></label>
