...
<head>
  ...
  <script src="<?php echo media_url() ?>/js/tab/jquery.dataTables.min.js"></script>
<script src="<?php echo media_url() ?>/js/tab/dataTables.bootstrap.min.js"></script>
<script src="<?php echo media_url() ?>/js/select2.full.min.js"></script>
<script>
  $(function () {
