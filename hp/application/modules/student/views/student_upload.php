			...
			<div class="col-xs-12">
				<div class="box box-success">
					...
					<div class="box-body table-responsive">
						...
						<p>Penginputan data <?php echo $this->config->item('siswa') ?> bisa dilakukan dengan mengcopy data dari file Ms. Excel. Format file excel harus sesuai kebutuhan aplikasi. Silahkan download formatnya <a href="<?php echo site_url('manage/student/download'); ?>"><span class="label label-success">Disini</span></a>
							<br><br>
