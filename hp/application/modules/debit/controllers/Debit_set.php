...
class Debit_set extends CI_Controller
{
	...
	public function __construct()
	{
		...
		$this->load->model(array('debit/Debit_model', 'debit_jenis/Debit_jenis_model', 'logs/Logs_model'));
	...
	{ 	$params = array();
		...
		if ($_POST and $this->form_validation->run() == TRUE) {
			...
			$params['debit_jenis_jenis_id'] = $this->input->post('debit_jenis_jenis_id');
			$params['debit_date'] = $this->input->post('debit_date');
