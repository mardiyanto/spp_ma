						...
						<table >
							<tbody>
								...
								<tr> 
									...
									<td width="70%">: <?php echo pretty_date($q['ds'], 'd F Y', false) . ' s/d ' . pretty_date($q['de'], 'd F Y', false) ?></td> 
								</tr>
								<tr> 
									<td>PETUGAS</td>
									<td width="70%">: <?php echo $this->session->userdata('ufullname') ?></td> 
								</tr>
								<tr>
									<td>TOTAL PENGELUARAN</td>
									<td width="70%">: Rp. <?php echo number_format($total, 0, ',', '.') ?></td> 
								</tr>
								<tr>
								<td>&nbsp;</td>
								</tr>
