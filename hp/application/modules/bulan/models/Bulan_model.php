...
class Bulan_model extends CI_Model
{
    ...
    function get($params = array())
    {
        ...
        if (isset($params['bulan_bill_total'])) {
            $this->db->where('bulan_bill_total', $params['bulan_bill_total']);
        }
        ...
        $this->db->select('bulan.bulan_id, bulan_bill,bulan_bill_total, bulan_date_pay, bulan_number_pay, bulan_pay_desc, bulan_status, bulan_input_date, bulan_last_update');
    ...
    function get_total($params = array())
    {
        ...
        $this->db->order_by('month_month_id', 'asc');
        $this->db->select('bulan.bulan_id, bulan_bill,bulan_bill_total, bulan_date_pay, bulan_status, bulan_pay_desc, bulan_input_date, bulan_last_update');
    ...
    function add($data = array())
    {
        ...
        if (isset($data['bulan_bill_total'])) {
            $this->db->set('bulan_bill_total', $data['bulan_bill_total']);
        }
