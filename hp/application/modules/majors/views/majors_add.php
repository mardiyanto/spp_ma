				...
				<div class="box box-success">
					...
					<div class="box-body">
						...
						<div class="form-group">
							<label>Nama <?php echo $this->config->item('jrr') ?> <small data-toggle="tooltip" title="Wajib diisi">*</small></label>
							<input name="majors_name" type="text" class="form-control" value="<?php echo $inputMajorsValue ?>" placeholder="Isi Nama ">
						</div>

						<div class="form-group">
							<label>Singkatan <?php echo $this->config->item('jrr') ?> <small data-toggle="tooltip" title="Wajib diisi">*</small></label>
