      ...
      <div class="navbar-header">
        <ul class="nav navbar-nav navbar-right">
          <?php if (isset($setting_school) and $setting_school['setting_value'] == '-') { ?>
            <li><a href="../../manage/"><span class='glyphicon glyphicon-stats' aria-hidden='true'></span>&nbsp;<b> E-SPPM</b></a></li>
          <?php } else { ?>
            <li><a href="../../manage/"><span class='glyphicon glyphicon-stats' aria-hidden='true'></span>&nbsp;<b> <?php echo $this->config->item('app_name') ?></b></a></li>
          <?php } ?>
        </ul>
    ...
    <div class="kotak">
      <div class="wrapper">
        ...
        <div class="row">
          ...
          <input type="text" required="" autofocus="" name="nis" placeholder="NIM" class="form-control flat">
        </div>
        <div class="row">
