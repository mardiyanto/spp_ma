...
--
-- Host: 127.0.0.1
-- Generation Time: 25 Jul 2023 pada 02.38
...
INSERT INTO `debit` (`debit_id`, `debit_date`, `debit_desc`, `debit_value`, `user_user_id`, `debit_input_date`, `debit_last_update`, `debit_jenis_jenis_id`) VALUES
(1, '2023-07-13', 'ORANG TUA ASUH', '2000000', 1, '2023-07-13 13:41:10', '2023-07-13 13:41:10', 1);
...
--
-- Dumping data untuk tabel `debit_jenis`
--

INSERT INTO `debit_jenis` (`debit_jenis_id`, `debit_jenis_date`, `debit_jenis_desc`, `debit_jenis_last_update`) VALUES
(1, '2023-07-13', 'INFAK', '2023-07-13 13:40:44');
...
(2, '2023-07-04', 'NGAJAR', '40000', '3', 1, 'khusus', '2023-07-04 13:13:04', '2023-07-13 13:16:31'),
(3, '2023-07-13', 'GAJI POKOK', '2000000', '2000000', 1, 'paket', '2023-07-13 13:14:01', '2023-07-13 13:14:01'),
(4, '2023-07-13', 'NGAJAR SD', '35000', '24', 1, 'khusus', '2023-07-13 13:17:53', '2023-07-13 13:17:53');
...
--
-- Dumping data untuk tabel `gaji_pay`
--

INSERT INTO `gaji_pay` (`gaji_pay_id`, `gaji_gaji_id`, `gaji_pay_date`, `gaji_pay_desc`, `gaji_pay_value`, `guru_guru_id`, `user_user_id`, `gaji_pay_input_date`, `gaji_pay_last_update`) VALUES
(1, 3, '2023-07-13', 'gapok', '2000000', 1, 1, '2023-07-13 13:14:52', '2023-07-13 13:14:52'),
(2, 4, '2023-07-13', 'GAJI JAM', '24', 1, 1, '2023-07-13 13:18:51', '2023-07-13 13:18:51');
...
INSERT INTO `kredit` (`kredit_id`, `kredit_jenis_jenis_id`, `kredit_date`, `kredit_desc`, `kredit_value`, `user_user_id`, `kredit_input_date`, `kredit_last_update`) VALUES
(1, 1, '2023-07-13', 'BELI BERAS', '120000', 1, '2023-07-13 13:43:37', '2023-07-13 13:43:37'),
(2, 1, '2023-07-13', 'BELI SAYUR DAN DAGING', '120000', 1, '2023-07-13 13:43:37', '2023-07-13 13:43:37');
...
--
-- Dumping data untuk tabel `kredit_jenis`
--

INSERT INTO `kredit_jenis` (`kredit_jenis_id`, `kredit_jenis_date`, `kredit_jenis_desc`, `kredit_jenis_last_update`) VALUES
(1, '2023-07-13', 'BELANJA HARIAN', '2023-07-13 13:42:31');
...
(11, '2023-07-13 13:14:01', 'Tambah', 'Tambah Gaji', 'ID:;Title:', 1),
(12, '2023-07-13 13:14:52', 'Tambah', 'Bayar Gaji', 'ID:3;Title:', 1),
(13, '2023-07-13 13:17:53', 'Tambah', 'Tambah Gaji', 'ID:;Title:', 1),
(14, '2023-07-13 13:18:51', 'Tambah', 'Bayar Gaji', 'ID:4;Title:', 1),
(15, '2023-07-13 13:24:57', 'Tambah', 'Jenis Pembayaran', 'ID:null;Title:', NULL),
(16, '2023-07-13 13:25:21', 'Tambah', 'Jenis Pembayaran', 'ID:null;Title:', NULL),
(17, '2023-07-13 13:26:23', 'Tambah', 'Jenis Pembayaran', 'ID:null;Title:', NULL),
(18, '2023-07-13 14:01:08', 'Hapus', 'user', 'ID:13;Title:ALUMNI', 1),
(19, '2023-07-13 14:07:09', 'Tambah', 'Jenis Pembayaran', 'ID:null;Title:', NULL);
...
(2, 'BEBAS', 1, 4, '2023-07-13 13:24:57', '2023-07-13 13:24:57'),
(3, 'BEBAS', 1, 3, '2023-07-13 13:25:21', '2023-07-13 13:25:21'),
(4, 'BEBAS', 1, 2, '2023-07-13 13:26:23', '2023-07-13 13:26:23'),
(5, 'BEBAS', 1, 5, '2023-07-13 14:07:09', '2023-07-13 14:07:09');
...
(1, 'SPP', 'SPP WAJIB'),
(2, 'SERAGAM', 'SERAGAM'),
(3, 'SARANA DAN PRASARANA', 'SARANA DAN PRASARANA'),
(4, 'PENDAFTARAN', 'PENDAFTARAN'),
(5, 'DU KENAIKAN KELAS', 'DAFTAR ULANG NAIK KELAS');
...
--
ALTER TABLE `class`
  MODIFY `class_id` int(254) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
--
-- AUTO_INCREMENT for table `debit`
--
ALTER TABLE `debit`
  MODIFY `debit_id` int(254) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `debit_jenis`
--
ALTER TABLE `debit_jenis`
  MODIFY `debit_jenis_id` int(254) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `gaji`
--
ALTER TABLE `gaji`
  MODIFY `gaji_id` int(254) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `gaji_pay`
--
ALTER TABLE `gaji_pay`
  MODIFY `gaji_pay_id` int(254) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
...
--
ALTER TABLE `kredit`
  MODIFY `kredit_id` int(254) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `kredit_jenis`
--
ALTER TABLE `kredit_jenis`
  MODIFY `kredit_jenis_id` int(254) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `letter`
--
ALTER TABLE `letter`
  MODIFY `letter_id` int(254) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT for table `logs`
--
ALTER TABLE `logs`
  MODIFY `log_id` int(254) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
--
...
--
ALTER TABLE `majors`
  MODIFY `majors_id` int(254) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
...
--
ALTER TABLE `payment`
  MODIFY `payment_id` int(254) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
...
--
ALTER TABLE `pos`
  MODIFY `pos_id` int(254) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
