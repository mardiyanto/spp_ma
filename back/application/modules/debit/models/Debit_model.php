...
class Debit_model extends CI_Model {
	...
	function get($params = array())
	{
		...
		if (isset($params['debit_jenis_jenis_id'])) {
			$this->db->like('debit_jenis_jenis_id', $params['debit_jenis_jenis_id']);
		}
		...
		$this->db->select('debit_id, debit_jenis_jenis_id, debit_date, debit_value, debit_desc, debit_input_date, debit_last_update');
		$this->db->select('debit_jenis_id , debit_jenis_desc');
	...
	function add($data = array()) {
		...
		if(isset($data['debit_jenis_jenis_id'])) {
			$this->db->set('debit_jenis_jenis_id', $data['debit_jenis_jenis_id']);
		}
