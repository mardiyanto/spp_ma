...
class Payment_set extends CI_Controller
{
  ...
  public function __construct()
  {
    ...
    $this->load->model(array('payment/Payment_model', 'student/Student_model', 'period/Period_model', 'pos/Pos_model', 'bulan/Bulan_model', 'bulan/Bulan_pay_model', 'bebas/Bebas_model', 'bebas/Bebas_pay_model', 'logs/Logs_model'));
  }
...
//      $params['search'] = $f['n'];
 ...
 // Tahun 
  ...
  public function delete_all_bebas($id = NULL, $student_id = NULL, $bebas_id = NULL)
  { $bebas_bebas_id = $_POST['bebas_bebas_id'];
    $this->db->where_in('bebas_id', $bebas_bebas_id);
...
// Delete payment Bebas
public function delete_payment_BUL($id = NULL, $student_id = NULL,  $payment_payment_id = NULL, $bulan_id = NULL)
  {
    $this->db->delete('bulan', array('student_student_id' => $student_id)); 
    $this->db->delete('bulan', array('payment_payment_id' => $payment_payment_id)); 
    $this->session->set_flashdata('success', 'Hapus Pembayaran Siswa berhasil');
    redirect('manage/payment/view_bulan/' . $id . '/' . $student_id . '/' . $bulan_id);
  }
  public function delete_all_bulan($id = NULL, $student_id = NULL, $bulan_id = NULL)
  { $dell = $_POST['del_all'];
    $dell_pay = $_POST['del_pay'];
    $this->db->where_in('student_student_id', $dell);
    $this->db->where_in('payment_payment_id', $dell_pay);
