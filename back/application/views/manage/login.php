...
<body>
  <nav class="navbar navbar-inverse navbar-fixed-top">
    <div class="col-md-12">
      ...
      <div class="navbar-header" id="navbar-main">
        <ul class="nav navbar-nav navbar-center">
          <li><a href="<?php echo base_url() ?>home"><span class='glyphicon glyphicon-random' aria-hidden='true'></span>&nbsp;<b>&nbsp; CEK PEMBAYARAN</b></a></li>
          <li><a href="<?php echo base_url() ?>student"><span class='glyphicon glyphicon-lock' aria-hidden='true'></span>&nbsp;<b>&nbsp; LOGIN <?php echo $this->config->item('siswa1') ?></b></a></li>
        </ul>
      </div>
    </div>
  </nav>
