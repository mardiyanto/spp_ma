<aside class="main-sidebar">
  <section class="sidebar">
    <ul class="sidebar-menu" data-widget="tree">
      <li class="<?php echo ($this->uri->segment(2) == 'dashboard' or $this->uri->segment(2) == 'tagihan' or $this->uri->segment(2) == NULL) ? 'active' : '' ?>">
      ...
      <li class="<?php echo ($this->uri->segment(2) == 'tagihan') ? 'active' : '' ?>">
        <a href="<?php echo site_url('student/payout'); ?>">
          <i class="fa fa-dollar"></i> <span>CEK TAGIHAN</span>
          <span class="pull-right-container"></span>
        </a>
      </li>
      <li>
